...
export default function App() {
  ...
  const [page,        setPage]        = useState("scanner"); // "scanner" | "oi"
      ...
      <div style={C.sidebar}>
        <div>
          ...
          <div style={{display:"flex",gap:4,marginTop:10}}>
            {[["scanner","📊 掃描器"],["oi","📈 OI儀表板"]].map(([v,l])=>(
              <button key={v} onClick={()=>setPage(v)}
                style={{flex:1,padding:"6px 4px",borderRadius:5,fontSize:10,fontFamily:"inherit",cursor:"pointer",
                  border:`1px solid ${page===v?"#5c6bc0":"#0f1629"}`,
