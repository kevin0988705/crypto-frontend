      ...
      <div style={{flex:1,overflowY:"auto",padding:"8px 10px"}}>
        {alerts.length===0?(
          ...
          alerts.map((a,i)=>{
            ...
            const bc = bc2||"#4caf50";
            const bg = bg2||"#0d282011";
            const isBearSetup = a.alertType==="bearSetup";
        const title = crash?"💥 暴跌預警":surge?"🚀 暴漲預警":isBearSetup?"⚠️ 準備下跌":"🚀 進場訊號";
        const bc2 = crash?"#ef5350":surge?"#ff9800":isBearSetup?"#ff7043":"#4caf50";
        const bg2 = crash?"#1a050511":surge?"#1a100011":isBearSetup?"#1a0a0011":"#0d282011";
